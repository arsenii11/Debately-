...
export function ConsentAndAnalytics() {
  ...
  const banner = bannerOpen ? (
      <div
        className="pointer-events-auto fixed inset-x-0 bottom-0 z-[200] max-h-[50dvh] touch-manipulation overflow-y-auto border-t border-zinc-800 bg-zinc-950/98 px-4 py-4 shadow-[0_-8px_40px_rgba(0,0,0,0.55)] backdrop-blur sm:px-6"
  ...
  return (
    <>
      {banner ? createPortal(banner, document.body) : null}
